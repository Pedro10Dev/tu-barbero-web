...
export default function Index({ services = [], barbers = [] }: Props) {
            ...
            <div className="mx-auto max-w-3xl">
                ...
                <div className="mb-10 text-center">
                    ...
                    <p className="mt-2 text-sm text-zinc-400">
                        Selecciona el servicio, tu barbero de preferencia y el
                        horario ideal.
                    </p>
                </div>
                                ...
                                <div>
                                    ...
                                    {loadingSlots ? (
                                        ...
                                        <p className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 text-xs text-amber-500">
                                            No existen turnos libres para esta
                                            fecha. Intenta con otro día.
                                        </p>
                                    )}
                                    {errors.time && (
                                        <p className="mt-2 text-xs text-red-400">
